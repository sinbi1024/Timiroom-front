...
<template>
  <article>
    ...
    <div class="summary-context">
      <div :class="scrollValue > 10&& scrollValue<930?'slide-left-action':'slide-left-actived'">
        <div class="sub-title ">
          <img class="icon">
      ...
      <div class="smf-sum" :class="scrollValue > 150&& scrollValue<1070?'slide-left-action':'slide-left-actived'">
      ...
      <div :class="scrollValue > 550 && scrollValue<1480?'slide-left-action':'slide-left-actived'">
        <div class="sub-title">
          <img class="icon ">
          <div class="summary-sub-title ">
            Second. Problems
      ...
      <div class="problems-sec" :class="scrollValue > 700?'slide-left-action':'slide-left-actived'">
        <img class="problems " src="/assets/image/problems.png">
      </div>

      <div :class="scrollValue > 1200?'slide-left-action':'slide-left-actived'">
        <div class="sub-title ">
          <img class="icon">
          <div class="summary-sub-title">
      ...
      <div class="smf-sum" :class="scrollValue > 1340?'slide-left-action':'slide-left-actived'">
