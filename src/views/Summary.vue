...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      nextTick(() => {
        ScrollReveal().reveal('.Fades', {duration: 700, reset: true});
      })
    })
    return {}
  }
...
<template>
  <article class="summary">
    ...
    <div class="summary-context">
      ...
      <div class="summary-title Fades">
        스마트 팩토리란?
      </div>

      <div class="smf-sum Fades">
      ...
      <div class="sub-title">
        <img class="icon Fades">
        <div class="summary-sub-title Fades">
          Second. Problems
        </div>
      </div>
